...
public enum ErrorEnum {
    ...
    ERR_503("503", "确认密码错误"),
    ERR_504("504", "昵称已被使用"),
    ERR_507("507", "请重新获取验证码"),
    ERR_510("510", "文本中使用违禁词汇"),
    ERR_515("515", "未获得邀请码授权"),

    //下行流量相关错误码
    ERR_10085("10085", "尚未购买下行流量，请联系我们。"),
    ERR_10086("10086", "下行流量已用完，请联系我们。"),

    //登录注册相关
    ERR_000039("000039", "登陆注册服务端异常");
