...
public class EncryptUtil {
   ...
   private static final int DEFAULT_ID_CARD_LENGTH = 18;
    ...
    public static void main(String[] args) throws Exception {
    	String aesEncrypt = EncryptUtil.aesEncrypt("18895397505", SecretKeyConstants.SECRET_KEY);
    	String aesDecrypt = EncryptUtil.aesDecrypt("C1F293236B49949322DBA88C2EE2B429", SecretKeyConstants.SECRET_KEY);
    	System.out.println(aesEncrypt);
    	System.out.println(aesDecrypt);
        System.out.println(EncryptUtil.aesEncrypt("15213064486", SecretKeyConstants.SECRET_KEY));
	}
}
